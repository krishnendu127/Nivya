            ...
            items: {
              ...
              properties: {
                ...
                ranking: {
                  ...
                  properties: {
                    expensePriority: { type: "string", enum: ["low-cost", "performance", "balanced"] },
                    consistencyPref: { type: "string", enum: ["stable", "volatile"] },
                    returnWindow: { type: "string", enum: ["1y", "3y", "5y"] },
                    preferredAmcs: { type: "array", items: { type: "string" }, maxItems: 20 },
                    avoidedAmcs: { type: "array", items: { type: "string" }, maxItems: 20 },
                    horizonMonths: { type: "integer", minimum: 1 },
                    safetyGrowth: { type: "number", minimum: 0, maximum: 100 },
                  },
                },
              },
            },
